...
describe("TrainingService Tests", () => {
    ...
    test("should train and register a Police officer", () => {
        ...
        // 결과 확인
        expect(result.introduction).toBe(`I am Police Officer John Doe, serving for 5 years.`);
        // 중앙 저장소에 등록 확인
    ...
    test("should train and register a Firefighter", () => {
        ...
        // 결과 확인
        expect(result.introduction).toBe(`I am Firefighter Jane Smith, serving for 3 years.`);
        // 중앙 저장소에 등록 확인
        const officers = CentralArchives.allOfficers;
        expect(officers).toHaveLength(1);
...
//# sourceMappingURL=police_command_pattern.test.js.map